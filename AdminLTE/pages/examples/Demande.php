...
$sql="select TypeStock from stock";
$result=mysqli_query($con,$sql);

 while($row=mysqli_fetch_assoc($result)){
   $TypeStock=$row['TypeStock'];
  }
            ...
            <section class="content">
              ...
              <i class="fas fa-times"></i>
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">ID de stock ou fournisseur :</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="IDF" placeholder="">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="">
                        <datalist id="datalistOptions">
                            <?php
                            echo '<option value="'.$TypeStock.'">'.$TypeStock.'</option>';
                            ?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="Quantite" placeholder="">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group-row">
                  <button type="submit" class="btn btn-info" style="float: right;border-radius 5px;margin-top:10px;">Demander</button>
                  </div>
                </div>
